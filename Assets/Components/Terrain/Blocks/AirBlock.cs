...
namespace Antymology.Terrain
{
    ...
    public class AirBlock : AbstractBlock
    {
        ...
        public void DepositPheromone(byte type, double amount, bool is_diffuse = false)
        {
            ...
            PheromoneField.Instance.Deposit(worldXCoordinate, worldYCoordinate, worldZCoordinate, type, (float)amount);
        ...
        {
            if (PheromoneField.Instance == null) return 0.0;
            return PheromoneField.Instance.Get(worldXCoordinate, worldYCoordinate, worldZCoordinate, type);
